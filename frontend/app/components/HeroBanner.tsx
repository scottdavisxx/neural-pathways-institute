...
export default function HeroBanner({ title, subtitle, cta, image, altText }: HeroBannerProps) {
  return (
    <div className="flex items-center justify-between h-screen bg-brand-blue text-white pl-20 overflow-visible">
      ...
      <Image src={image} alt={altText} width={1000} height={1000} className="absolute right-0 bottom-0 max-w-1/2 h-10/12 object-cover" />
    </div>
  )
}